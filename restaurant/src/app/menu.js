...
export default function createMenu() {
  ...
  card.addEventListener('mouseover', () => { document.getElementById('character-img').src = './eugene-money.png'; });
  card.addEventListener('mouseleave', () => { document.getElementById('character-img').src = './eugene.png'; });
